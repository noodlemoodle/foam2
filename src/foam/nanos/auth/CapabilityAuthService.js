    ...
    },
    {
      ...
      javaCode: `
        ...
        try {
          ...
          if ( cap != null && agent != null && ( cap instanceof net.nanopay.crunch.AgentCapability ) && (user instanceof net.nanopay.model.Business ) ) {
          ...
          // 3. check if the user has a capability that grants the permission
